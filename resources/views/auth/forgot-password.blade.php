...
<head>
    ...
    <title>Mot de passe oublié - {{ config('app.name', 'Caron') }}</title>
...
<body class="min-h-screen bg-slate-50 flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            ...
            @endif
            <h1 class="text-xl font-semibold text-slate-900">Mot de passe oublié</h1>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            ...
            <div class="mt-4 pt-4 border-t border-slate-100 text-center">
                <a href="{{ route('login') }}" class="text-xs text-primary-600 hover:text-primary-700 font-medium">
